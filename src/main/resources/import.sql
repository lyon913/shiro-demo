insert into UserInfo(loginName,fname,fpassword,fgroupName,fgroup) values('admin','系统管理员','1234','系统管理组','GROUP_ADMIN');

insert into UserInfo(loginName,fname,fpassword,fgroupName,fgroup) values('user1','赵受理','1234','受理','GROUP_SL');
insert into UserInfo(loginName,fname,fpassword,fgroupName,fgroup) values('user2','钱审核','1234','审核','GROUP_SH');
